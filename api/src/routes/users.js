...
router.put("/passwordReset", async (req, res) => {
  ...
  if(userId & adminId){
    ...
    if(findUser && findAdmin) {
      ...
      res.send(`Password updated successfully. User notification sent to ${findUser.email}`)
    ...
    return res.send("User not found or not authorized to perform this action")
  }
